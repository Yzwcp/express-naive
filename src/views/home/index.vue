	...
	<AppPage show-footer>
		<div class="flex">
			...
			<n-card class="ml-12 w-70%" title="✨ 欢迎使用 Vue Naive Admin 2.0">
				...
				<p class="opacity-60">
					这是一款极简风格的后台管理模板，包含前后端解决方案，前端使用 Vite + Vue3 + Pinia + Unocss，后端使用 Nestjs +
					TypeOrm + MySql，简单易用，赏心悦目，历经十几次重构和细节打磨，诚意满满！！
				</p>
				<footer class="mt-12 flex items-center justify-end">
					<n-button type="primary" ghost tag="a" href="https://isme.top" target="__blank"> 开发文档 </n-button>
					<n-button
						type="primary"
						class="ml-12"
						tag="a"
